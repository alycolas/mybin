...
curl -s "https://sc.ftqq.com/SCU21184T2d614d48b5363a867d22c51324f8afc05a728a2da6f1a.send?text=NewMovie" -d "&desp=名字：$TR_TORRENT_NAME %0D%0A%0D%0A目录：$TR_TORRENT_DIR"
...
# do
	getsub -o "$PWD"
#	subliminal download -l zh -l en "$PWD"
# done
